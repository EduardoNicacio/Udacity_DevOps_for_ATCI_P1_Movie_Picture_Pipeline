...
The following lists provide you with the deliverables for the backend application of this project.
...
⚠️ **NOTE**: Once you begin work on Continuous Deployment, you'll need to first setup the AWS and Kubernetes environment. Follow the next set of instructions when you're ready to start testing your deployments.
