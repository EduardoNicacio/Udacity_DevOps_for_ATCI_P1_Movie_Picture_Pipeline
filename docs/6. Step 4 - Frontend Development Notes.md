...
Your task is to take out only the relevant commands to be placed in your workflow YAML files. For example, `nvm` is not needed when you use GitHub action [actions/setup-node](https://github.com/actions/setup-node).
